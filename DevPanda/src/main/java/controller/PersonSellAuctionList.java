...
public class PersonSellAuctionList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (filterOption != null) {
				personSellAuctionList = service.personSellAuctionListByDate(sellerId, filterDateStr);
			} else if (startDate != null && !startDate.isEmpty() && endDate != null && !endDate.isEmpty()) {
				personSellAuctionList = service.personSellAuctionListByDateRange(sellerId, startDate, endDate);
			} else {
				personSellAuctionList = service.personSellAuctionList(sellerId);
			}
