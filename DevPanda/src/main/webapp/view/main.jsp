...
<section class="mb-8">
        ...
        <div class="category-container">
            ...
            <div>
                ...
                <div id="category6-content" class="category-content hidden">
                    ...
                    <label><input type="checkbox" name="certifications" value="기타 영어 자격증"> 기타 영어 자격증</label><br>
                    <label><input type="checkbox" name="certifications" value="정보처리산업기사"> 정보처리산업기사</label><br>
	...
	document.addEventListener('DOMContentLoaded', function () {
	    // 모든 카테고리 버튼과 콘텐츠를 가져옵니다
	    const categoryButtons = document.querySelectorAll('.category-item');
	    
	    categoryButtons.forEach(button => {
	        button.addEventListener('click', function () {
	            // 현재 버튼과 관련된 콘텐츠를 찾습니다
