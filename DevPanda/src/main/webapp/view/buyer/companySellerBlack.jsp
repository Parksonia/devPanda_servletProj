	...
	<div class="container my">
		...
		<div class="content_area my-page-content">
			<div class="my_blacklist">
								...
								<div class="list_item_status">
									...
									<div class="list_item_column column_last">
										<button class="btn btn_add" type="button"
											onclick="removeBlacklist(${black.blackId})">해제하기</button>
										<!-- 버튼에 해제 처리해야함  -->
									</div>
								</div>
							</div>
				...
				<script>
        const modal = document.querySelector('.modal'); // 기존 스크립트인데 빼면 작동을 안함 이유를 모르겠음
        ...
        modalCloseButton.addEventListener('click', function() {
            modal.style.display = 'none';
				...
				// 해제 버튼 스크립트
				function removeBlacklist(blackId) {
            		...
            		// AJAX 요청
                		...
                		data: { blackId: blackId }, // 전송할 데이터  여기서 데이터가 null로 넘어감@@@@@@@
