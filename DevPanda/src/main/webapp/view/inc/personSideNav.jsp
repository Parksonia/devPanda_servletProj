	...
	<div class="snb_area">
		...
		<nav class="snb">
			<div class="snb_list">
				...
				<ul class="snb_menu">
					<li class="menu_item"><a href="bidList" class="menu_link">입찰내역조회</a></li>
					<li class="menu_item"><a href="personBuyTransactionList" class="menu_link">낙찰내역조회</a></li>
			...
			<div class="snb_list">
				...
				<ul class="snb_menu">
					<li class="menu_item"><a href="personSellAuctionList" class="menu_link">경매등록 내역조회</a></li>
					<li class="menu_item"><a href="personSellTransactionList" class="menu_link">낙찰내역조회</a></li>
